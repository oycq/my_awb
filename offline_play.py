...
while True:
    ...
    if current_frame != last_frame:
        file = sorted_files[current_frame]
        ...
        # 处理图像
        cached_processed_img = isp.isp_process(img)
        
        last_frame = current_frame
    
    if cached_processed_img is None:
        continue
    
    processed_img = cached_processed_img.copy()  # 复制以添加文本
